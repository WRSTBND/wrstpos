...
import * as custom from "../custom-variables";
...
let pos = {
    ...
    secondary: '#EF18B9',
    secondaryLight: `rgba(${anyColorToRgbString("#EF18B9")}, 0.1)`,
    secondaryTouch: `rgba(${anyColorToRgbString("#EF18B9")}, 0.2)`,
    surface: "#262626",
    onSurface: "#555555",
    primary: '#FF9100',
    primaryLight: `rgba(${anyColorToRgbString("#FF9100")}, 0.1)`,
    primaryVariant: '#FFEA00',
    primaryVariantLight: `rgba(${anyColorToRgbString("#FFEA00")}, 0.1)`,
    primaryTouch: `rgba(${anyColorToRgbString("#FF9100")}, 0.2)`,
    primaryVariantTouch: `rgba(${anyColorToRgbString("#FFEA00")}, 0.2)`,
    error: '#FF1744'
};
...
//
export { brand, background, border, contrast, font, spacing, button, input, navigation, tabContainer, listView, layoutGrid, badge, pos};
